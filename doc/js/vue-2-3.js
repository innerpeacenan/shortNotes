...
// explicitness and function inlining
    ...
    var config = ({
         ...
         *
         * @play [Difference between Object.create(null) vs {}?
         ](http://stackoverflow.com/questions/37471799/difference-between-object-createnull-vs)
         */
...
// these are reserved for web2 because they are directly compiled away
...
// check platforms/web2/util/attrs.js acceptValue
...
// Special Elements (can contain anything)
    ...
    /*
    * onRE是匹配@或v-on开头的属性，也就是我们添加事件的语法。

     dirRE是匹配v-或@或:开头的属性，即vue中的绑定数据或事件的语法。

     forAliasRE匹配v-for中的属性值，比如item in items、(item, index) of items。

     forIteratorRE是对forAliasRE中捕获的第一部分内容，进行拆解，我们都知道v-for中in|of前最后可以有三个逗号分隔的参数。
