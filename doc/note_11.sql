...
CREATE TABLE `items` (
  ...
  KEY `u_time` (`u_time`),
  KEY `rank` (`rank`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='items';
...
CREATE TABLE `notes` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='notes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t` (
  ...
  `name` char(200) NOT NULL COMMENT 'table name',
  `ddl` text COMMENT 'table data defination language',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='data defiination language of all tables';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-12-26  0:50:54
